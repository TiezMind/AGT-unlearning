...
memory_dir="../memory"
pretrained_model_path="paper_models/tofu-gemma-2-2b-it_lora_privacy"

forget_val_data_path="dataset/TOFU/forget10_perturbed.json"
retain_val_data_path="dataset/TOFU/retain_perturbed.json"
